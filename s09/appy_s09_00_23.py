...
#
# Time-stamp: <2025/10/28 21:53:36 (UT+08:00) daisuke>
#
...
# output file name
file_output = 'appy_s09_00_23.png'
...
# title
text_title = f"Distribution of asteroids on the sky"
ax.set_title (text_title, loc='right')

# plotting data
density = ax.hexbin (numpy.deg2rad (array_ra_deg), \
                     numpy.deg2rad (array_dec_deg), \
